...
//  cvSetCaptureProperty(capture,CV_CAP_PROP_POS_FRAMES,5);  
 // Create a window in which the captured images will be presented
   ...
   while ( 1 ) {
     ...
     cvInRangeS(hsvframe,cvScalar(20, 100, 220),cvScalar(40, 150, 260),threshframe); //cvInRangeS(input frame, cvScalar(min range),cvScalar(max range),output frame)
